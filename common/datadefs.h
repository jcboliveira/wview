...
typedef struct
{
	...
	float               hourchangeatemp;             // difference in degrees
	float               hourchangeatemp1;             // difference in degrees
	float               hourchangesoiltemp1;              // difference in degrees
	int16_t             hourchangesoilmoist1;              // difference in degrees
	int16_t             hourchangeleafwet1;              // difference in degrees
	...
	float               daychangeatemp;              // difference in degrees
	float               daychangeatemp1;              // difference in degrees
	float               daychangesoiltemp1;              // difference in degrees
	int16_t             daychangesoilmoist1;              // difference in degrees
	int16_t             daychangeleafwet1;              // difference in degrees
	...
	float               weekchangeatemp;             // difference in degrees
	float               weekchangeatemp1;             // difference in degrees
	float               weekchangesoiltemp1;              // difference in degrees
	int16_t             weekchangesoilmoist1;              // difference in degrees
	int16_t             weekchangeleafwet1;              // difference in degrees
} SENSOR_STORE;
...
typedef struct
{
	...
	float               tenMinuteAvgWindSpeed;  /* mph                    */
	...
	float            twoMinuteAvgWindSpeed;
	float            tenMinuteWindGust;
	uint16_t            WinddirtenMinuteWindGust;
...
//               processing:
#define ARCHIVE_VALUE_NULL          -1000
typedef struct
{
	// minimum required fields - station must provide these:
...
typedef struct
{
	...
	float			highSolRad;
	float			lowSolRad;
	float			meanExtraTemp1;
	float			highExtraTemp1;
	float			lowExtraTemp1;
	float			meanExtraTemp2;
	float			highExtraTemp2;
	float			lowExtraTemp2;
	float			meanSoilTemp1;
	float			highSoilTemp1;
	float			lowSoilTemp1;
	float			meanSoilMoist1;
	float			highSoilMoist1;
	float			lowSoilMoist1;
	float			meanLeafWet1;
	float			highLeafWet1;
	float			lowLeafWet1;
