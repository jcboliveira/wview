...
typedef struct
{
	...
	uint16_t            dayET;
	uint16_t            Last24HourRain;
	uint8_t             BarometricReduction;
	uint16_t            BarometricOffset;
	uint16_t            Barometriccalibration;
	uint16_t            BarometricSensorRaw;
	uint16_t            AbsoluteBarometric;
	uint16_t            AltimeterSetting;
	uint8_t             Unused7;
	uint8_t             Unused8;
	uint8_t             Next10minWindSpeed;
	uint8_t             Next15minWindSpeed;
	uint8_t             NextHourlyWindSpeed;
	uint8_t             NextDailyWindSpeed;
	uint8_t             NextMinuteRainGraph;
	uint8_t             NextRainStormGraph;
	uint8_t             IndextotheMinutewithin;
	uint8_t             NextMonthlyRain;
	uint8_t             NextYearlyRain;
	uint8_t             NextSeasonalRain;
	uint8_t             Unused9[12];
	uint8_t             lf;
	uint8_t             cr;
	uint16_t            crc;
} __attribute__((packed)) LOOP2_DATA;
